...
class AssemblyCodegen(Linearizer):
  ...
  def codegen(self):
    ...
    for uop,newvar,vin,args in self.uops:
      if uop is UOps.CONST and newvar is not None:
      ...
      elif uop is UOps.CAST and newvar is not None:
      ...
      elif uop is UOps.ALU and newvar is not None:
        ...
        elif args is BinaryOps.DIV and self.no_div:
        ...
        elif args is UnaryOps.SIN and self.sin_is_sin2pi:
      ...
      elif uop is UOps.LOAD and newvar is not None:
